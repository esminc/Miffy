...
class Asf4MemberServiceTest {
    ...
    public void selectAll_GetAllData() {
        ...
        expectedMembers.add(new Asf4Member(1,"スナッフィー", "test1", "4", false, null, true));
        expectedMembers.add(new Asf4Member(2,"ボリス", "test2", "4", false, null,false));
        expectedMembers.add(new Asf4Member(3,"バーバラ", "test3", "4", true, "1階に移動しました",false));
        // 実行
    ...
    public void selectByIdobataId_GetExpectedMember() {
        // 準備
        Asf4Member expectedSelectedMember = new Asf4Member(1,"スナッフィー", "test1", "4", false, null, true);
        // 実行
    ...
    public void update_editTest() {
        // 準備
        List<Asf4Member> expectedMembers = new ArrayList<>();
        expectedMembers.add(new Asf4Member(1,"ポピーさん", "test4", "4", false,null, true));
        expectedMembers.add(new Asf4Member(2,"ボリス", "test2", "4", false,null, false));
        expectedMembers.add(new Asf4Member(3,"バーバラ", "test3", "4", true, "1階に移動しました",false));
        // 実行
        asf4MemberService.update(new Asf4Member(1,"ポピーさん", "test4", "4", false, null,true));
        List<Asf4Member> actualMembers = asf4MemberService.selectAll();
        // 検証
        assertEquals(expectedMembers, actualMembers);
    }
    ...
    public void deleteTest() {
        ...
        expectedMembers.add(new Asf4Member(2,"ボリス", "test2", "4", false, null, false));
        // 実行
        asf4MemberService.delete(new Asf4Member(3,"バーバラ", "test3","4", true, "1階に移動しました", false));
        List<Asf4Member> actualMembers = asf4MemberService.selectAll();
        // 検証
        assertEquals(expectedMembers, actualMembers);
    }
    ...
    public void update_createNewMemberTest() {
        ...
        expectedMembers.add(new Asf4Member(4,"ポピーさん", "test4", "4", false, null, false));
        // 実行
        asf4MemberService.update(new Asf4Member(4,"ポピーさん", "test4", "4", false, null, false));
        List<Asf4Member> actualMembers = asf4MemberService.selectAll();
        // 検証
        assertEquals(expectedMembers, actualMembers);
    }
